			...
			<div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg  w-full">
				<div class="bg-white px-4 py-3 items-center justify-between border-t border-gray-200 sm:px-6">
					<div class="flex text-gray-500">
						...
						<input type="text"
						name="" class="form-input w-full test-gray-500 ml-6 mb-3"
						wire:model="search"
						...
						<thead class="bg-gray-50">
							<tr>
								...
								<th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
									...
									<button wire:click="sorteable('comunidades_id')">
										<span class="fa fa{{ $camp === 'comunidades_id' ? $icon:'-circle'}} "></span>
									</button>
								</th>
								<th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
									PROPIETARIO ID
									<button wire:click="sorteable('users_id')">
										<span class="fa fa{{ $camp === 'users_id' ? $icon:'-circle'}} "></span>
									</button>
								</th>
								<th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
								...
								<th scope="col" class="relative px-6 py-3">
									<span class="sr-only fa fa-cogs">Edit</span>
								</th>
								<th scope="col" class="relative px-6 py-3">
									<span class="sr-only fa fa-eraser">Delete</span>
								</th>
							</tr>
						</thead>
